...
public class ViewContasReceber extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbPagarConta.setText("Receber conta");
    ...
    private void jbPagarContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbPagarContaActionPerformed
        ...
        if(tbContasReceber.getSelectedRow()>=0){
       ...
       // System.out.println(formdata.getData());
        int linha = tbContasReceber.getSelectedRow();
        int id = (int) tbContasReceber.getValueAt(linha, 0);
        
            if(controllerConta.pagarConta(id, formdata.getData()) ){
                JOptionPane.showMessageDialog(this, "Conta recebida com sucesso!");
    ...
    private boolean recuperarConta(int pCodigoConta) {
        ...
        try {
            Date data = bld.converterDataStringParaDate( modelConta.getPagamento() );
        ...
        this.jtfObservacao.setText(modelConta.getObservacao());
        return true;
    }
    ...
    private boolean salvar() {
        ...
        try {
            ...
            modelConta.setPagamento( jdPagamento.getDateFormatString() );
        } catch (Exception ex) {
            Logger.getLogger(ViewVenda.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        modelConta.setSituacao(0);
        modelConta.setValor( this.jtfValor.getfloat() );
   ...
   /**
    ...
    private boolean alterar() {
        ...
        try {
            modelConta.setData(bl.converterDataParaDateUS(jdData.getDate()));
            modelConta.setVencimento(bl.converterDataParaDateUS(jdVencimento.getDate()));
            modelConta.setPagamento( DataClasses.dataToUS(jdPagamento.getDateFormatString())  );
        } catch (Exception ex) {
            Logger.getLogger(ViewVenda.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        //salvar 
        if (controllerConta.atualizarContaReceberController(modelConta)) {
     ...
     private void carregarContasReceber() {
        ...
        for (int i = 0; i < cont; i++) {
            ...
            modelo.addRow(new Object[]{
                ...
                nomeCliente,
                bld.formatarData(listaModelConta.get(i).getData() ),
                bld.formatarData(listaModelConta.get(i).getVencimento() ),
                DataClasses.converterFloatParaMoeda(listaModelConta.get(i).getValor(), true)
            });
        }
    }
    ...
    private boolean revogarConta(){
        ...
        if (opcao == JOptionPane.OK_OPTION) {
            if (controllerConta.revogarConta(codigo)) {
