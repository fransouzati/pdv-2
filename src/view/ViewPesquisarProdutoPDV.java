...
public class ViewPesquisarProdutoPDV extends javax.swing.JDialog {
    ...
    public ViewPesquisarProdutoPDV(java.awt.Frame parent, boolean modal) {
        ...
        jtProdutos.getInputMap(JComponent.WHEN_ANCESTOR_OF_FOCUSED_COMPONENT)
                .put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "Enter");
        jtProdutos.getActionMap().put("Enter", new AbstractAction() {
        @Override
    ...
    private void doClose(int retStatus) {
        ...
        String cod = (String) jtProdutos.getValueAt(linha, 0);
        //returnStatus = codigo;
        returnCode = cod;
        setVisible(false);
        dispose();
