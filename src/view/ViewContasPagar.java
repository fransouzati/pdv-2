...
public class ViewContasPagar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbPagarConta = new javax.swing.JToggleButton();
        jbVisualizarPagar = new javax.swing.JButton();
        jPanel2 = new javax.swing.JPanel();
        btCancelar1 = new javax.swing.JButton();
        jpRevorgarConta = new javax.swing.JToggleButton();
        ...
        jtfPesquisa2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtfPesquisa2ActionPerformed(evt);
            }
        });
        ...
        jPanel3.add(jbPagarConta, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 380, -1, -1));
        ...
        jPanel2.add(btCancelar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 382, -1, -1));
        ...
        jtfPesquisa1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtfPesquisa1ActionPerformed(evt);
            }
        });
    ...
    private void btAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAlterarActionPerformed
        try {
            ...
            this.jdPagamento.setEnabled(true);
    ...
    private void jbPagarContaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbPagarContaActionPerformed
        ...
        if(tbContasPagar.getSelectedRow()>=0){
            
        ViewDataConta formdata = new ViewDataConta(this, rootPaneCheckingEnabled);
        formdata.setVisible(true);
       // System.out.println(formdata.getData());
        int linha = tbContasPagar.getSelectedRow();
        int id = (int) tbContasPagar.getValueAt(linha, 0);
        
            if(controllerContaPagar.pagarConta(id, formdata.getData()) ){
    ...
    private void jtfPesquisa2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfPesquisa2ActionPerformed
        jbPesquisar2ActionPerformed(evt);
    }//GEN-LAST:event_jtfPesquisa2ActionPerformed

    private void jtfPesquisa1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfPesquisa1ActionPerformed
        jbPesquisar1ActionPerformed(evt);
    }//GEN-LAST:event_jtfPesquisa1ActionPerformed
  
    
    private boolean revogarConta(){

        int linha = tbContasPagas.getSelectedRow();
        
        if(linha>=0){        
        int codigo = (int) tbContasPagas.getValueAt(linha, 0);
        int opcao = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja revogar a conta"
                + " código "+codigo+"?", "Atenção", JOptionPane.YES_NO_OPTION);

        if (opcao == JOptionPane.OK_OPTION) {
            if (controllerContaPagar.revogarConta(codigo)) {
                JOptionPane.showMessageDialog(null, "Registro revogado com suscesso!");
                carregarContasPagar();
                carregarContasPagas();
            } else {
                JOptionPane.showMessageDialog(this, "Erro no processo!", "ERRO", JOptionPane.ERROR_MESSAGE);
                return false;
            }
        }
        }
    ...
    private boolean recuperarConta(int pCodigoConta) {
        modelContaPagar = new ModelConta();
        modelContaPagar = controllerContaPagar.getContaPagarController(pCodigoConta);
        this.jcbClientes.setSelectedItem(controllerCliente.getClienteController(modelContaPagar.getCodigoPessoa()).getNome());
        ...
        try {
            Date data = bld.converterDataStringParaDateUS(modelContaPagar.getPagamento());
            this.jdPagamento.setDate(data);
        } catch (Exception ex) {
            Logger.getLogger(ViewContasPagar.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        
        this.jdVencimento.setDate(modelContaPagar.getVencimento());
        this.jtfValor.setText( DataClasses.converterFloatParaMoeda(modelContaPagar.getValor(), false) );
        this.jcbTipoPagamento.setSelectedItem(controllerTipoPagamento.getTipoPagamentoController(modelContaPagar.getTipoPagamento()).getDescricao());
    ...
    private boolean salvar() {
        ...
        modelContaPagar.setCodigoPessoa(controllerCliente.getClienteController(this.jcbClientes.getSelectedItem().toString()).getCodigo());
...
//            modelContaPagar.setPagamento( jdPagamento.getDate().toString() );
        } catch (Exception ex) {
            Logger.getLogger(ViewVenda.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        modelContaPagar.setSituacao(0);
        modelContaPagar.setValor(this.jtfValor.getfloat());
        modelContaPagar.setTipoPagamento(controllerTipoPagamento.getTipoPagamentoController(this.jcbTipoPagamento.getSelectedItem().toString()).getCodigo());
   ...
   /**
    ...
    private boolean alterar() {
        ...
        try {
            modelContaPagar.setPagamento( DataClasses.dataToUS(jdPagamento.getDateFormatString()) );
            modelContaPagar.setData(bl.converterDataParaDateUS(jdData.getDate()));
            modelContaPagar.setVencimento(bl.converterDataParaDateUS(jdVencimento.getDate()));
     ...
     private void carregarContasPagar() {
        ...
        for (int i = 0; i < cont; i++) {
            ...
            modelo.addRow(new Object[]{
                ...
                nomeCliente,
                bld.formatarData(listamModelContaPagar.get(i).getData()),
                bld.formatarData(listamModelContaPagar.get(i).getVencimento()),
                DataClasses.converterFloatParaMoeda(listamModelContaPagar.get(i).getValor(), true)
            });
        }
    }
    ...
    private javax.swing.JToggleButton jbPagarConta;
    ...
    private javax.swing.JToggleButton jpRevorgarConta;
    ...
    private util.CampoDinheiro jtfValor;
