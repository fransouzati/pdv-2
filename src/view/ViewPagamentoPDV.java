...
public class ViewPagamentoPDV extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jtfValorRecebido = new util.CampoDinheiro();
        ...
        okButton.setForeground(new java.awt.Color(51, 102, 255));
        okButton.setText("Confirmar Pagamento");
        okButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                okButtonActionPerformed(evt);
            }
        });
        getContentPane().add(okButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 400, 190, 50));
        ...
        getContentPane().add(jcbTipoPagamento, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 20, 340, 39));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 264, 510, -1));
        ...
        getContentPane().add(jtfTroco, new org.netbeans.lib.awtextra.AbsoluteConstraints(72, 399, 140, 44));

        jtfValorRecebido.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        getContentPane().add(jtfValorRecebido, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 200, 110, 50));

        lb_subtotal.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        lb_subtotal.setForeground(new java.awt.Color(0, 102, 255));
        lb_subtotal.setText("Valor");
        getContentPane().add(lb_subtotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 79, -1, 40));
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
     //   this.desconto = Float.parseFloat(this.jtfDesconto.getText());
        this.valorRecebido = DataClasses.converterMoedaParaFloat(this.jtfValorRecebido.getText());
       // this.troco = Float.parseFloat(this.jtfTroco.getText());
        this.totalPagar = DataClasses.converterMoedaParaFloat(this.jlfValorPagar.getText());
    ...
    private void jtfValorRecebidoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtfValorRecebidoFocusLost
       jtfTroco.setText( DataClasses.converterFloatParaMoeda(calcularTroco(), true) );
    ...
    private float calcularTroco(){        
        this.troco = DataClasses.converterMoedaParaFloat(this.jtfValorRecebido.getText()) - valorTotal;
        return this.troco;
    }
    ...
    private util.CampoDinheiro jtfValorRecebido;
   ...
   public void setTextFildValorTotal(){
       this.lb_subtotal.setText(DataClasses.converterFloatParaMoeda(this.valorTotal,false));
   }
    ...
    public void setTotalPagar(float totalPagar) {
        ...
        jlfValorPagar.setText(DataClasses.converterFloatParaMoeda(totalPagar, false));
    }
    ...
    /**
     * Limpa todos os valores tal como total, valor recebido, desconto etc... 
     * 
     */
    public void limparValores(){
        
        this.jlfValorPagar.setText("");
        this.lb_subtotal.setText("");
        this.jtfValorRecebido.setText("");
        this.jtfTroco.setText("");
