...
public class ViewFluxoCaixa extends javax.swing.JFrame {
    ...
    private ArrayList<ModelCaixa> listaModelCaixa = new ArrayList<>();
    ...
    private void initComponents() {
        ...
        tbFluxoCaixa.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Terminal", "Operador", "Dinheiro", "Crédito", "Débito", "Cheque", "Convênio", "Vale", "Total"
            }
        ) {
    ...
    private void listarTodas(){
     ...
     private void carregarCaixasAberto(){
         
         listaModelCaixa = controllerCaixa.getListaCaixaController(ModelCaixa.CAIXA_ABERTO);
        DefaultTableModel modelo = (DefaultTableModel) tbFluxoCaixa.getModel();
        modelo.setNumRows(0);
        int cont = listaModelCaixa.size();
        
        for (int i = 0; i < cont; i++) {
            
            modelo.addRow(new Object[]{
                listaModelCaixa.get(i).getIdTerminal(),
                listaModelCaixa.get(i).getOperador(),
                DataClasses.converterFloatParaMoeda(listaModelCaixa.get(i).getDinheiro(), true),
                DataClasses.converterFloatParaMoeda(listaModelCaixa.get(i).getCartao(), true),
                DataClasses.converterFloatParaMoeda(listaModelCaixa.get(i).getDebito(), true),
                DataClasses.converterFloatParaMoeda(listaModelCaixa.get(i).getCheque(), true),
                DataClasses.converterFloatParaMoeda(listaModelCaixa.get(i).getConvenio(), true),
                DataClasses.converterFloatParaMoeda(listaModelCaixa.get(i).getVale(), true),
                DataClasses.converterFloatParaMoeda(listaModelCaixa.get(i).getTotal(), true)
            });
        }
