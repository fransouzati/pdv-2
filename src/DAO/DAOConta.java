...
public class DAOConta extends ConexaoMySql {
    ...
    public ModelConta getContaPagarDAO(int pCodigo){
        ...
        try {
            ...
            while(this.getResultSet().next()){
                ...
                modelConta.setPagamento(this.getResultSet().getString(6));
    ...
    */
    public boolean atualizarContaPagarDAO(ModelConta pModelContaPagar){
        try {
            ...
            if(pModelContaPagar.getPagamento()!="0000-00-00"){
                sql = sql.concat("pagamento = '" + pModelContaPagar.getPagamento()+ "',");
            }
            
            sql = sql.concat("fk_tipo_pagamento = '" + pModelContaPagar.getTipoPagamento() + "',"
    ...
    */
    ...
    public boolean revogarContaDao(int cod){
